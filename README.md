...
+ — 3:29 PM
เปลี่ยนเเค่ input output
บอกมันไปงั้น
ไอบีม — 3:29 PM
เอาโค้ดมา
กุจะให้มันแก้ตามโค้ด
+ — 3:30 PM
มันโค้ดเดิม
คือมึงจะเอา github ให้มันดูทีเดียวช่ะ
ไอบีม — 3:30 PM
โค้ดไหนๆ
ใช่
+ — 3:30 PM
...
Untitled.ipynb
2.79 MB
Segmented landscape to Realistic Urban city view 
ต้องบอกมัน
+ — 3:44 PM
Epoch ที่ 1
Image
...
5555555555
ไอบีม — 3:44 PM
ไอ้เหี้ยละเมหือนจริง
+ — 3:44 PM
ไม่ๆเเต่ละสีมีความหาย
รอมันดีกว่านี้
กูจะเเคปมาทุกๆ 10 epoch
เอาไปใส่ docs
รอสักำัก
ไอบีม — 3:46 PM
ดะกุเอาลงไอจี
อันนี้คืออะไร ท่าเรือ ?
+ — 3:47 PM
ท่าเรือก็เเย่ละ
หมู่บ้าน
ครับเฮีย
...
มึงจำมะวานได้ปะ
สรุป 3 คนนั้นออกละ
เจอกุปั่นงานงานไป 2 อัน 1 วัน
ร้องเลย แม่งบอกพี่กุว่า 3 สัปดาห์
กุจะรั่ว
+ — 4:55 PM
อ่าว
+ — 4:55 PM
...
กูใส่ที่เหลือเองได้
ไอบีม — 5:23 PM
งั้นมึงต้องเอาเท่าที่มีมาให้กุตอนนี้
ดะไฟล์โค้ดนั้น
ดะกุไล่เขียนให้ก่อน
+ — 5:24 PM
อันนี้เลยไฟลโค้ด
เเค่เปลี่ยน จาก edge to face -> Segmented Urban street to Realistic Urban street 
dataset https://www.kaggle.com/datasets/electraawais/cityscape-dataset/code/data
คำอธิบาย = Pix2pix Guagans Segmented Landscape to Realistic Urban street 
A take on Nvdas Gaugans with pix2pix architecture and urban street dataset
ให้ ai gen
รูปถูฏหมดเเล้ว
ไม่ต้องเเก้
ไอบีม — 8:52 PM
...
เดี่ยวกุทำเสด
มึงนั่งไล่แก้เอานะ
มึงต้องนั่งเช้คทุกบรรทัดนะ
บางอันมันก้แปลกๆ
กุรุ้สึกได้
ดะกุรีบปั่นให้อีก 30 นาที
+ — 8:52 PM
อาเค
จะดิสไหม
กูจะเสดละ
...
## สมาชิกในกลุ่ม
- สมาชิกคนที่ 1: [ระบุชื่อ]
- สมาชิกคนที่ 2: [ระบุชื่อ]
